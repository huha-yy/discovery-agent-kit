...
It is intended for teams that need repeatable agent behavior across projects, not just inside one codebase.
...
The current recommended public release is `v0.2.0`.
...
This repository is published under the Apache-2.0 license. See `LICENSE`.
